            ...
            options: {
                ...
                scales: {
                    yAxes: [{
                        ...
                        ticks: {min: 0, maxTicksLimit: 7, suggestedMax: 100},
                    }, {
                        id: 'tsb',
                        scaleLabel: {labelString: 'TSB', display: true},
                        ticks: {maxTicksLimit: 7, suggestedMin: -30, suggestedMax: 30},
                        position: 'right',
